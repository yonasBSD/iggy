...
async-compression: 0.4.32, "Apache-2.0 OR MIT",
...
aws-lc-rs: 1.14.1, "(Apache-2.0 OR ISC) AND ISC",
aws-lc-sys: 0.32.3, "(Apache-2.0 OR ISC) AND ISC AND OpenSSL",
...
clap: 4.5.50, "Apache-2.0 OR MIT",
clap_builder: 4.5.50, "Apache-2.0 OR MIT",
clap_complete: 4.5.59, "Apache-2.0 OR MIT",
...
compression-codecs: 0.4.31, "Apache-2.0 OR MIT",
...
find-msvc-tools: 0.1.4, "Apache-2.0 OR MIT",
...
fs-err: 3.1.3, "Apache-2.0 OR MIT",
fs_extra: 1.3.0, "MIT",
...
ignore: 0.4.24, "MIT OR Unlicense",
...
js-sys: 0.3.81, "Apache-2.0 OR MIT",
jsonwebtoken: 9.3.1, "MIT",
jsonwebtoken: 10.1.0, "MIT",
jwalk: 0.8.1, "MIT",
...
quote: 1.0.41, "Apache-2.0 OR MIT",
...
serde_with: 3.15.1, "Apache-2.0 OR MIT",
serde_with_macros: 3.15.1, "Apache-2.0 OR MIT",
...
unicode-ident: 1.0.20, "(Apache-2.0 OR MIT) AND Unicode-3.0",
...
wasm-bindgen: 0.2.104, "Apache-2.0 OR MIT",
wasm-bindgen-backend: 0.2.104, "Apache-2.0 OR MIT",
wasm-bindgen-futures: 0.4.54, "Apache-2.0 OR MIT",
wasm-bindgen-macro: 0.2.104, "Apache-2.0 OR MIT",
wasm-bindgen-macro-support: 0.2.104, "Apache-2.0 OR MIT",
wasm-bindgen-shared: 0.2.104, "Apache-2.0 OR MIT",
wasm-streams: 0.4.2, "Apache-2.0 OR MIT",
wasm-timer: 0.2.5, "MIT",
web-sys: 0.3.81, "Apache-2.0 OR MIT",
web-time: 1.1.0, "Apache-2.0 OR MIT",
webpki-root-certs: 1.0.3, "CDLA-Permissive-2.0",
webpki-roots: 0.26.11, "CDLA-Permissive-2.0",
webpki-roots: 1.0.3, "CDLA-Permissive-2.0",
