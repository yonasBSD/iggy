...
use crate::create_stream::CreateStream;
use crate::delete_stream::DeleteStream;
use crate::get_stream::GetStream;
use crate::get_streams::GetStreams;
use crate::purge_stream::PurgeStream;
use crate::traits::binary_auth::fail_if_not_authenticated;
use crate::traits::binary_mapper;
use crate::update_stream::UpdateStream;
use crate::{Identifier, IggyError, Stream, StreamClient, StreamDetails};
...
impl<B: BinaryClient> StreamClient for B {
    ...
    async fn create_stream(&self, name: &str) -> Result<StreamDetails, IggyError> {
        ...
        let response = self
            ...
            .await?;
        binary_mapper::map_stream(response)
    }
